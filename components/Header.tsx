      ...
      <div className={'flex-1 flex justify-end items-center p-2'}>
        <div className={'flex lg:w-1/4 justify-end items-center md:gap-4 gap-2'}>
          ...
          <div className='bg-muted p-2 rounded-xl'>
            {currentAccount !== null ? `${currentAccount.slice(0, 7)}...${currentAccount.slice(35)}` : (<Button className={`rounded-xl relative bg-gradient-to-r  from-green-600 to-green-800 md:text-sm text-xs h-8 px-2 md:h-10 md:py-2 md:px-4`}  onClick={connectWallet}>
